                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="button" class="btn btn-blue btn-sm" data-toggle="modal" data-target="#modalBarang">
                    ...
                    <tbody>
                        <?php foreach ($barang as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row->stok; ?></td>
                                <td>
                                    <button data-stok="<?= $row->stok; ?>" data-kode="<?= $row->kdBarang; ?>" type="button" class="btn btn-pilih btn-sm btn-blue">
