            ...
            <div class="card-header bg-white">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="<?= base_url('barang/add') ?>" class="btn btn-sm btn-blue">
                    ...
                    <tbody>
                        ...
                        foreach ($barang as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" data-stok="<?= $row->stok; ?>" data-nama="<?= $row->namaBarang; ?>" data-kode="<?= $row->kdBarang; ?>" class="btn btn-sm btn-blue btn-tambahstok">
                                            <i class="fa fa-plus"></i>
                                        </button>
                                        <a href="<?= base_url('barang/edit/') . $row->kdBarang ?>" class="btn btn-sm btn-blue">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a onclick="return confirm('Yakin ingin hapus data?')" href="<?= base_url('barang/hapus/') . $row->kdBarang ?>" class="btn btn-sm btn-blue">
